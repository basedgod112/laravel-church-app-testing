                    ...
                    <form method="POST" action="{{ route('admin.records.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="sacrament_type" id="sacrament_type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                                ...
                                <option value="eucharist" {{ old('sacrament_type') == 'eucharist' ? 'selected' : '' }}>Eucharist</option>
                                <option value="marriage" {{ old('sacrament_type') == 'marriage' ? 'selected' : '' }}>Marriage</option>
                                <option value="ordination" {{ old('sacrament_type') == 'ordination' ? 'selected' : '' }}>Ordination</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="sacrament_date" id="sacrament_date" value="{{ old('sacrament_date') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="location" id="location" value="{{ old('location') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                            @error('location')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="officiant" id="officiant" value="{{ old('officiant') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                            @error('officiant')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" id="notes" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('notes') }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
